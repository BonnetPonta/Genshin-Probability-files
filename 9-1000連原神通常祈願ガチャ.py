...
while True:
    ...
    if 1 <= nmb <= 60:
        limit5 = limit5 + 1
    if cnt90 == 90 and limit5 == 0:
        nmb = 1
    if cnt90 == 90 or limit5 >= 1:
        limit5 = 0
        cnt90 = 0
    ...
    if nmb <= 60:
        print(cnt, "回目：", "5キャラ")
        star5 = star5 + 1
        character_name = random.randint(1, 5)
        if character_name == 1:
        ...
        if character_name == 5:
            character_cnt_seven = character_cnt_seven + 1
    if 61 <= nmb <= 315:
        print(cnt, "回目：", "4キャラ")
        star4c = star4c + 1
    if 316 <= nmb <= 570:
    ...
    if cnt1000 == 1000:
        ...
        print("ジン", '\033[33m', character_cnt_zin, '\033[0m', "刻晴", '\033[33m', character_cnt_kokusei, '\033[0m', "モナ", '\033[33m', character_cnt_mona, '\033[0m',
              "ディルック", '\033[33m', character_cnt_deil, '\033[0m', "七七", '\033[33m', character_cnt_seven, '\033[0m', "星5PUキャラ", '\033[33m', character_cnt_arubedo, '\033[0m')
        break
